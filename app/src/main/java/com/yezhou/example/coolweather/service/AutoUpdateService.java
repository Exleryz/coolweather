package com.yezhou.example.coolweather.service;
...
public class AutoUpdateService extends Service {
    ...
    private void updateWeather() {    // 更新天气信息
        ...
        if (weatherString != null) {    // 有缓存时直接解析天气数据
            ...
            String weatherUrl = "http://guolin.tech/api/weather?cityid=" +
                    weatherId + "&key=d1a98958750e4fdeb92aa46aeffbf5c2";
    ...
    private void updateBingPic() {    // 更新必应每日一图
